using back_agenda_inteligente.Data;
using back_agenda_inteligente.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace back_agenda_inteligente.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class CompromissosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Compromisso>> PostCompromisso(Compromisso compromisso)
        {
            ...
            return CreatedAtAction(nameof(GetCompromisso), new { id = compromisso.Id }, new Compromisso());
        }
